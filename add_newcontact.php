<?php
	...
	$api_token       = $_SESSION['api_token'];         //TOKEN PARA ENVIO DA MENSAGEM DE BOAS VINDAS
	// ***************************************
    // VARIÁVEIS FIXAS 
						  ...
						  $posicao = 5; 
						   ...
						   if ($posicao > 0 )
						   {
						       $sql = "SELECT name FROM tags LIMIT 1";
								 ...
								 $sql = "INSERT INTO contatos (numero,nome,status,posicao,user_cli,data_rg,data_rt,tag) ";
								 $sql .= "VALUES ('".$whatsapp."','".$nome."',"."0".",".$posicao.",'".$user_cli."','".$data_rg."',' ".$data_rt." ', ' ".$name." ')"; 	
